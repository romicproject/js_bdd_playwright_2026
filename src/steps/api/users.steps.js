...
When(
  ...
  async ({ apiContext, apiHelpers }) => {
    expect(
      apiContext.createdUserEmail,
      "createdUserEmail is not set.",
    ).toBeTruthy();
    expect(
      apiContext.createdUserPassword,
      "createdUserPassword is not set.",
    ).toBeTruthy();
...
When(
  ...
  async ({ apiContext, apiHelpers }) => {
    expect(
      apiContext.savedUserEmail,
      "savedUserEmail is not set.",
    ).toBeTruthy();
    expect(
      apiContext.savedUserPassword,
      "savedUserPassword is not set.",
    ).toBeTruthy();
...
When(
  ...
  async ({ apiContext, apiHelpers }, email, password) => {
    ...
    apiContext.untrackCleanupUser(resolveEmail(apiContext, email));
  },
);
...
When(
  ...
  async ({ apiContext, apiHelpers }) => {
    ...
    apiContext.untrackCleanupUser(apiContext.savedUserEmail);
  },
);
