...
export async function createAccountWithUniqueUser({
  homePage,
  loginPage,
  registerPage,
  uiContext,
...
export async function ensureAccountCreatedAndLoggedIn({
  homePage,
  loginPage,
  registerPage,
  uiContext,
...
export async function assertDuplicateEmailErrorWithContext({
  loginPage,
  uiContext,
}) {
  try {
