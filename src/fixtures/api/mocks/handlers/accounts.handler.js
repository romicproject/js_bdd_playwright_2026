...
export function handleCreateAccount(apiContext, requestData, pathname, method) {
...
export function handleVerifyLogin(apiContext, requestData, pathname, method) {
...
export function handleDeleteAccount(apiContext, requestData, pathname, method) {
